...
(function()
{
	...
	function WatchImg(img)
	{
		...
		fla.src = "/testPro/js/plugins/webp/WebP.swf";
		fla.width = 28;
		fla.height = 28;
	...
	function setup_ie678()
	{
		...
		dummy.removeBehavior(dummy.addBehavior("/testPro/js/plugins/webp/WebP.htc"));

		document.createStyleSheet()
			.addRule("img", "behavior:url(/testPro/js/plugins/webp/WebP.htc)");
